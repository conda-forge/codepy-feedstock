...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/codepy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13737&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/codepy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `codepy` can be installed with:

```
conda install codepy
```

It is possible to list all of the versions of `codepy` available on your platform with:
